...
//
uint8_t ssd1306_Init(void *hi2c)
{
    ...
    status += ssd1306_WriteCommand(hi2c, 0xA0);   // Set segment re-map 0 to 127
...
//
void ssd1306_UpdateScreen(void *hi2c)
{
    uint8_t i;

    for (i = 0; i < 8; i++) {
        ssd1306_WriteCommand(hi2c, 0xB0 + i);
        ssd1306_WriteCommand(hi2c, 0x00 + SH1106_COLUMN_OFFSET);
